...
const API_BASE_URL = "https://gestion-3kgo.onrender.com";
              ...
              <Route
                ...
                element={
                  <ProtectedRoute
                    ...
                    authLoading={authLoading}
                  >
                    <Consorcios API_BASE_URL={API_BASE_URL} />
                  </ProtectedRoute>
                }
              />
              <Route
              ...
              <Route
                ...
                element={
                  <ProtectedRoute
                    ...
                    authLoading={authLoading}
                  >
                    <AddConsorcio API_BASE_URL={API_BASE_URL} />
                  </ProtectedRoute>
                }
              />
              <Route
                path="/edit-consorcio/:id"
                element={
                  <ProtectedRoute
                    roles={["admin", "employee"]}
                    isAuthenticated={isAuthenticated}
                    ...
                    authLoading={authLoading}
                  >
                    <EditConsorcio API_BASE_URL={API_BASE_URL} />
                  </ProtectedRoute>
                }
              />

              <Route
                path="/add-inquilino/:consorcioId"
                element={
                  <ProtectedRoute
                    roles={["admin", "employee"]}
                    isAuthenticated={isAuthenticated}
                    ...
                    authLoading={authLoading}
                  >
                    <AddInquilino API_BASE_URL={API_BASE_URL} />
                  </ProtectedRoute>
                }
              />
              <Route
                ...
                element={
                  <ProtectedRoute
                    ...
                    authLoading={authLoading}
                  >
                    <InquilinoDetail API_BASE_URL={API_BASE_URL} />
                  </ProtectedRoute>
                }
              />
              <Route
                ...
                element={
                  <ProtectedRoute
                    ...
                    authLoading={authLoading}
                  >
                    <EditInquilino API_BASE_URL={API_BASE_URL} />
                  </ProtectedRoute>
                }
              />

              <Route
                path="/add-activo/:consorcioId"
                element={
                  <ProtectedRoute
                    roles={["admin", "employee"]}
                    isAuthenticated={isAuthenticated}
                    ...
                    authLoading={authLoading}
                  >
                    <AddActivo API_BASE_URL={API_BASE_URL} />
                  </ProtectedRoute>
                }
              />
              <Route
                ...
                element={
                  <ProtectedRoute
                    ...
                    authLoading={authLoading}
                  >
                    <ActivoDetail API_BASE_URL={API_BASE_URL} />
                  </ProtectedRoute>
                }
              />
              <Route
                ...
                element={
                  <ProtectedRoute
                    ...
                    authLoading={authLoading}
                  >
                    <EditActivo API_BASE_URL={API_BASE_URL} />
                  </ProtectedRoute>
                }
              />
              <Route
                ...
                element={
                  <ProtectedRoute
                    ...
                    authLoading={authLoading}
                  >
                    <ActivoList API_BASE_URL={API_BASE_URL} />
                  </ProtectedRoute>
                }
              />
