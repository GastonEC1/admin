...
const LoginMap = ({ authToken }) => {
  ...
  const mapInstanceRef = useRef(null); // ✨ NUEVO ESTADO: Guarda el login seleccionado
  const [selectedLogin, setSelectedLogin] = useState(null); // useEffect para cargar los datos del historial
  ...
  useEffect(() => {
    ...
    fetchLoginHistory();
  }, [authToken]); // Lógica para centrar el mapa
...
          `);
  ...
  }, [history, selectedLogin]); // ✨ NUEVO HANDLER: Función para manejar el clic en la tabla
        ...
        <div className="table-responsive">
          ...
          <table className="table table-striped table-hover mt-3">
            ...
            <thead>
              ...
              <tr>
                                <th>Usuario</th>               {" "}
                <th>Fecha y Hora</th>                <th>Latitud</th>           
                    <th>Longitud</th>             {" "}
              </tr>
                         {" "}
            </thead>
