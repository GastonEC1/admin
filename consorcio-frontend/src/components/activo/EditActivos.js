...
function EditActivo() {
  ...
  const [frecuenciaMantenimiento, setFrecuenciaMantenimiento] =
    useState("No aplica");
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setFechaInstalacion(
          activoData.fechaInstalacion
            ? new Date(activoData.fechaInstalacion).toISOString().split("T")[0]
            : ""
        );
        setProximoMantenimiento(
          activoData.proximoMantenimiento
            ? new Date(activoData.proximoMantenimiento)
                .toISOString()
                .split("T")[0]
            : ""
        );
        setFrecuenciaMantenimiento(
          activoData.frecuenciaMantenimiento || "No aplica"
        );
        ...
        setFechaUltimoMantenimiento(
          activoData.fechaUltimoMantenimiento
            ? new Date(activoData.fechaUltimoMantenimiento)
                .toISOString()
                .split("T")[0]
            : ""
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMessage(
        "Error al actualizar el activo. Por favor, revisa los datos."
      );
        ...
        <Form onSubmit={handleSubmit} className="mt-3">
          ...
          <Row>
            <Col md={6}>
              <Form.Group
                className="mb-3"
                controlId="formFrecuenciaMantenimiento"
              >
            ...
            <Col md={6}>
              <Form.Group className="mb-3" controlId="formEstado">
                ...
                >
                  ...
                  <option value="Pendiente de Mantenimiento">
