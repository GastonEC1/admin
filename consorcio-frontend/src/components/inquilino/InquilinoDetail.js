...
function InquilinoDetail() {
  ...
  if (!inquilino) {
    return (
      <Container className="mt-5">
        <Alert variant="info">Inquilino no encontrado.</Alert>
      </Container>
    );
  }
  ...
  return (
    <Container className="mt-5">
      {inquilino.consorcio && inquilino.consorcio._id ? (
        <Link
          to={`/consorcios/${inquilino.consorcio._id}`}
      ...
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text>
            ...
            <br />
            <strong>Teléfono:</strong> {inquilino.telefono || "N/A"}
            <br />
            <strong>Unidad:</strong> {inquilino.unidad}
            <br />
            <strong>Tipo de Unidad:</strong> {inquilino.tipoUnidad || "N/A"}
            <br />
          ...
          <div className="mt-3">
            <Link
              to={`/edit-inquilino/${inquilino._id}`}
